...
- **Disable / revert to stock Claude Code:**
  `powershell -NoProfile -ExecutionPolicy Bypass -File $env:USERPROFILE\.claude\usage-pacing\deactivate.ps1`
...
- **Re-enable:**
  `powershell -NoProfile -ExecutionPolicy Bypass -File $env:USERPROFILE\.claude\usage-pacing\activate.ps1`
